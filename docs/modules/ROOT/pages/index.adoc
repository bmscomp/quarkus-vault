...
:root-token: hvs.CAGyHiZRcfwKJxFid89IsWfH
...
----
docker run --rm --cap-add=IPC_LOCK -e VAULT_ADDR=http://localhost:8200 -p 8200:8200 -d --name=dev-vault hashicorp/vault:{vault-version}
----
...
Administrative Namespace:
   ...
   Environment Variables: GODEBUG, GOTRACEBACK, HOME, HOSTNAME, NAME, PATH, PWD, SHLVL, VAULT_ADDR, VERSION
              Go Version: go1.21.1
...
Unseal Key: 9dpic2encyOaYsWwoIlw9GSPohTsAjgIQyGLVZOBrnA=
